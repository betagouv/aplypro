...
describe Stats::Indicator::Ratio::AttributiveDecisions do
  let(:indicator) { Stats::Main.new(SchoolYear.current.start_year).indicators[:attributive_decisions_ratio] }
