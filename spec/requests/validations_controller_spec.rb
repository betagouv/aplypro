...
RSpec.describe ValidationsController do
  ...
  describe "GET #show" do
    before { get validation_school_year_class_path(SchoolYear.current.start_year, classe) }
  ...
  describe "POST #validate" do
    context "with valid attributes" do
      it "validates selected pfmps" do
        expect do
          post validation_school_year_class_path(SchoolYear.current.start_year, classe),
