...
class AttributeDecisionGenerator
  ...
  def render
    ...
    composer.text("#{student.full_name}, né(e) le #{I18n.l(student.birthdate)}, ci-après désigné «le bénéficiaire», pour l'année scolaire 2023-2024.")
    ...
    composer.text(" Le bénéficiaire est informé que l’établissement conservera l’ensemble des documents et éléments relatifs à l’attribution de son allocation en faveur des lycéens professionnels dans le cadre de la valorisation des périodes de formation en milieu professionnel pendant une période au moins égale à 10 ans à compter des derniers versements.")

    composer.text(" Dans le cadre de contrôles ou d’audits, l’établissement pourra se rapprocher du bénéficiaire afin d’obtenir des éléments complémentaires jusqu’à 10 ans après la fin de l’année scolaire.")

    composer.text(" Article 8 : Litiges", style: :paragraph_title)

    composer.text(" En cas de contestation de la décision, le bénéficiaire peut exercer un recours gracieux ou hiérarchique auprès du recteur dans un délai de 2 mois à compter de la notification de cette décision.")
    ...
    composer.text(" Le bénéficiaire en sera informé en amont par l’établissement.")
    ...
    composer.text("SOUS RESERVE DE LA VALIDATION DE LA DIRECTION DES AFFAIRES JURIDIQUE DU MINISTERE")
    ...
    composer.text(" Vous pouvez exercer vos droits d’accès, de rectification et de limitation prévus par les articles 15, 16 et 18 du RGPD auprès du chef d’établissement, sur place, par voie postale ou par voie électronique. Les droits à l’effacement et à l’opposition ne s’appliquent pas au présent traitement.")
    ...
    composer.text(" Décision d’attribution éditée le #{I18n.l(Date.today)} par validation informatique du responsable légal de l'établissement.")
  end
  ...
  def summary
    ...
    composer.text("Addresse mail de l'établissement : #{student.establishment.email}")
    composer.text("Téléphone de l'établissement : #{student.establishment.telephone}")
  end
