...
class AttributeDecisionGenerator
  ...
  def render
    ...
    composer.text("#{student.full_name}, né(e) le #{I18n.l(student.birthdate)}, ci-après désigné « le bénéficiaire », inscrit en « #{@schooling.mef.label} (MEF : #{@schooling.mef.code}) » pour l'année scolaire 2023-2024.")
