...
module AttributeDecision
  ...
  class Abrogator < DocumentGenerator
    ...
    def articles
      ...
      composer.text("#{student.full_name}, né(e) le #{I18n.l(student.birthdate, format: :long)}, résidant au #{address_copy}, ci-après désigné « le bénéficiaire », pour l'année scolaire #{@school_year}.", style: :paragraph)
