...
class Pfmp < ApplicationRecord # rubocop:disable Metrics/ClassLength
  ...
  def within_schooling_dates?
    ...
    return true if (schooling.open? && start_date && self.start_date >= start_date) || schooling.no_dates?

    (schooling.start_date..schooling.max_end_date).cover?(self.start_date..end_date)
  end
